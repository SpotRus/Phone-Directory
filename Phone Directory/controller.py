    ...
    while True:
        ...
        match choice:
            ...
            case 4:
                ...
                view.print_message(text.new_contact_add_successful(contact[0]))
            case 5:
                find_contact(pb)
            case 6:
                find_contact(pb)
                ...
                view.print_message(text.contact_change_successfil(c_contact[0]))
            case 7:
                find_contact(pb)
                c_id = int(view.input_data(text.input_id_delete_contact))
                name = pb.delete_contact(c_id)[0]
                view.print_message(text.contact_delete_successfil(name))
            case 8:
